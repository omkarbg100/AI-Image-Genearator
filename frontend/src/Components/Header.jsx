...
const Header = () => {
    ...
    return (
        <motion.div initial={{ opacity: 0.2, y: 100 }} transition={{ duration: 1 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className='flex flex-col justify-center items-center text-center my-20'>
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 rounded-full border border-neutral-500'>
            ...
            <motion.h1
                ...
                className='text-3xl max-w-[600px] sm:text-6xl sm:max-w-[590px] mx-auto mt-10 text-center'>Turn Text to <br /> <span className='text-blue-600'>Image</span> , in Seconds</motion.h1>
